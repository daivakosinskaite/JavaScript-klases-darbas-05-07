...
const bookByCategory = (categoryName)=>{
    // 1. Atfiltruoti pagal kategorija knygas
    let results =  library.filter((category)=> category.name == categoryName)[0].books;
    for(let book of results){
        console.log(book.title)
        //2. Atvaizduoti html liste
...
console.log(bookByCategory('Fantasy'))
